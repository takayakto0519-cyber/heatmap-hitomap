          ...
          <div style={{ maxWidth: 720, margin: '0 auto' }}>
            {STEPS.map((s, i) => (
              ...
              >
                ...
                <div>
                  <p style={{ margin: '0 0 8px', fontFamily: corpFont.mincho, fontSize: 17, fontWeight: 600, color: corpColor.sumi }}>
                    {s.title}
                  </p>
                  <p style={{ margin: 0, fontSize: 14, color: corpColor.sumiSoft, lineHeight: 1.9, fontFamily: corpFont.body, maxWidth: 500 }}>
                    {s.body}
                  </p>
                </div>
              </div>
            ...
            <div style={{ borderTop: `1px solid ${corpColor.line}`, padding: '28px 0 0' }}>
              ...
              <p style={{ margin: '0 0 24px', fontSize: 14, color: corpColor.sumiSoft, lineHeight: 1.9, fontFamily: corpFont.body }}>
              ...
              <p style={{ marginTop: 20, fontSize: 12, color: corpColor.tsuchiSoft, fontFamily: corpFont.body }}>
