        ...
        <section style={{ background: corpColor.white, padding: '8px 24px 72px' }}>
          <div style={{ maxWidth: 720, margin: '0 auto' }}>
            <div style={sectionStyle}>
              <h2 style={{ fontFamily: corpFont.mincho, fontSize: 19, fontWeight: 600, color: corpColor.sumi, margin: '0 0 14px' }}>
                解読型の採用・組織ブランディング
              </h2>
              <p style={{ fontSize: 14, color: corpColor.sumiSoft, lineHeight: 2, margin: 0, fontFamily: corpFont.body }}>
            ...
            <div style={sectionStyle}>
              ...
              <p style={{ fontSize: 14, color: corpColor.sumiSoft, lineHeight: 2, margin: '0 0 20px', fontFamily: corpFont.body }}>
              ...
              <div style={{ display: 'grid', gap: 10 }}>
                {PHASES.map(([phase, desc]) => (
                  <div key={phase} style={{ display: 'flex', gap: 16, alignItems: 'baseline' }}>
                    <span style={{ fontSize: 12, fontWeight: 700, color: corpColor.shu, flexShrink: 0, width: 70, fontFamily: corpFont.body }}>
                      {phase}
                    </span>
                    <span style={{ fontSize: 14, color: corpColor.sumiSoft, fontFamily: corpFont.body }}>{desc}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={sectionStyle}>
              ...
              <ul style={{ margin: 0, paddingLeft: 18, fontSize: 14, color: corpColor.sumiSoft, lineHeight: 2.1, fontFamily: corpFont.body }}>
                <li>社員トレーディングカード</li>
            ...
            <div style={sectionStyle}>
              ...
              <p style={{ fontSize: 14, color: corpColor.sumiSoft, lineHeight: 2, margin: 0, fontFamily: corpFont.body }}>
                まちあるき記録アプリで集まった痕跡・感情データを、地域振興や観光施策の検討材料としてご活用いただける形での
                ご提供も行っています。まずは個別にご相談ください。
              </p>
            </div>
