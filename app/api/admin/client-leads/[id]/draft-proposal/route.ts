...
## 構成
1. 表紙（団体名・日付。差出人は「ヒトマップ」と個人事業として名乗る。「株式会社」「〜運営一同」等、
   法人・複数人組織を思わせる表記は絶対に使わない）
...
- 【自然な日本語】「〜を推進。」「〜と重なる。」のような体言止め・断片的な言い切りを連続させない。
  主語と述語がそろった、人が読んで違和感のない文章にする。証拠パックの中に調査メモの略記や記号
  （「R1:パターン(1)①」等）が含まれていても、それをそのまま転記せず、必ず自然な文章に書き直す
- 【法人ではなく個人事業】ヒトマップは加藤貴也の個人事業（屋号）であり、株式会社ではない。
  「株式会社」「ヒトマップ運営一同」「〜チーム」等、法人・複数人組織を思わせる表記は本文のどこにも使わない
- 相手の政策・計画名を挙げる際は、名前を並べるだけで終わらせず、その政策が何を目指すものかを
  一文で要約したうえで、ヒトマップの提案との繋がりを説明する
