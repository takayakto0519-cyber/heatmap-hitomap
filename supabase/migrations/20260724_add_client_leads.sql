-- 学校・法人向け問い合わせ/契約管理表（04_人事クライアント管理の「縁のデータベース」に対応）
CREATE TABLE IF NOT EXISTS client_leads (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  client_type text NOT NULL DEFAULT 'business', -- school | business
  org_name text NOT NULL,
  contact_name text,
  email text,
  phone text,
  status text NOT NULL DEFAULT 'lead', -- lead | contacted | negotiating | contracted | lost
  memo text,
