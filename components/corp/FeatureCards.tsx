...
const FEATURES: {
...
}[] = [
  {
    Icon: PinIcon,
    title: '痕跡を記録する',
    body: '修理された椅子、色あせた看板。まちで気になったモノを、写真と一言で地図に残せます。文章が苦手でも、撮ってタップするだけです。',
  },
  {
    Icon: SparkleIcon,
    title: '感情を一緒に残す',
    body: 'ときめき、なつかしさ、切なさ——。10種類の感情から選んで、「なぜ心が動いたのか」まで痕跡に刻むことができます。',
  },
  {
    Icon: MapIcon,
    title: '感情の地図が育つ',
    body: '記録が積み重なると、町ごとの感情の濃淡がヒートマップとして浮かび上がります。あなたの記録が、町の見え方を変えていきます。',
  },
];
